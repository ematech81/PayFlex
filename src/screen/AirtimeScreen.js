...
export default function AirtimeScreen({ navigation }) {
  ...
  const { wallet, updateTransactionPinStatus } = useWalletBalance();
...
// // const BASE_URL_AIRTIME = 'http://192.168.100.210:5000/api/';
// const BASE_URL = 'http://192.168.100.210:5000/api/payments';
